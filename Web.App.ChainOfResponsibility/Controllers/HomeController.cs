...
using Web.App.ChainOfResponsibility.ChainOfResponsibility;
...
namespace BaseProject.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> SendEmail()
        {
            ...
            var sendEmailProcessHandler = new SendEmailProcessHandler("product.zip", "karl.macgyver@ethereal.email");
